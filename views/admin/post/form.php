...
<form action="<?= isset($params['post']) ? "http://localhost/cours-2024/oop-php-framework-master/admin/posts/edit/{$params['post']->id}" : "http://localhost/cours-2024/oop-php-framework-master/admin/posts/create" ?>" method="POST">
